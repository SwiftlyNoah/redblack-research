...
$-0.005$ at $n=3{,}200$ games per arm (artifact
\code{pool\_solve-6-cfrpolicy\_vs\_solve2.json}).
...
$\epsilon_G \ge -0.005$ $[-0.040,\,+0.030]$ at $n=3{,}200$ games per
arm, against the incumbent store's $+0.031$ $[-0.004,\,+0.065]$ at the
same $n$ and seeds. The probe's win rate against it is
indistinguishable from a coin flip, so the claim of record is
non-inferiority; the artifact is
\code{pool\_solve-6-cfrpolicy\_vs\_solve2.json}. The enumeration in
